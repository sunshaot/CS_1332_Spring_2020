...
public class ArrayStack<T> {
    ...
    public void push(T data) {
        if (data == null) {
            throw new IllegalArgumentException("Error, cannot add null to the stack!");
        } else {
    ...
    public T pop() {
        if (size == 0) {
            throw new NoSuchElementException("Error, cannot pop element from empty stack!");
        } else {
    ...
    public T peek() {
        if (size == 0) {
            throw new NoSuchElementException("Error, cannot get peek from empty stack!");
        } else {
